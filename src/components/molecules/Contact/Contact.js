    ...
    <>
      <div id="Contact" className="custom-content-section">
        ...
        >
          ...
          <div className="custom-contact-location" style={{ flex: 2.5 }}>
            <li>
              <a href="https://adsecurity.co/">Ad - Security </a>
            </li>
            <li>
              <a href="https://www.xrm.com.co/">xRM</a>
            </li>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div id="Icono" style={{ flex: 2 }}>
            <a href="https://www.linkedin.com/in/intelecto-soluciones-y-tecnolog%C3%ADa-b134a364/">
              <img
                width="60"
                heigth="60"
            ...
            <a href="https://www.facebook.com/Intelecto.co/">
              <img
                width="60"
                heigth="60"
            ...
            <a href="https://www.instagram.com/intelecto.co/">
              <img
                width="60"
                heigth="60"
            ...
            <a href="https://twitter.com/IntelectoLtda">
              <img
                width="60"
                heigth="60"
