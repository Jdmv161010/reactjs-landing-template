    ...
    <>
      <div id="Contact" className="custom-content-section">
        ...
        >
          ...
          <div className="custom-contact-location" style={{ flex: 2.5 }}>
            <li>
              <a target="_blank" get href="https://adsecurity.co/">
                Ad - Security{" "}
              </a>
            </li>
            <li>
              <a target="_blank" get href="https://www.xrm.com.co/">
                xRM
              </a>
            </li>
          </div>
        ...
        >
          ...
          <div id="Icono" style={{ flex: 2 }}>
            ...
            <a target="_blank" get href="https://www.facebook.com/Intelecto.co/">
              <img
                width="60"
                heigth="60"
            ...
            <a target="_blank" get href="https://www.instagram.com/intelecto.co/">
              <img
                width="60"
                heigth="60"
            ...
            <a target="_blank" get href="https://twitter.com/IntelectoLtda">
              <img
                width="60"
                heigth="60"
